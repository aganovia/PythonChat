...
def start_chat(username):
    ...
    send_button = Button(window, text="Send", font=("Arial", 14), command=lambda: press("Send", my_username))
    send_button.pack()
...
# button clicks on sign-in screen
